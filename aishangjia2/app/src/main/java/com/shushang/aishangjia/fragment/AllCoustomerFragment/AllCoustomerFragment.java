...
public class AllCoustomerFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener, BaseQuickAdapter.RequestLoadMoreListener{
...
//        getData(orderType,sort,source);
    ...
    private void getData(String orderType,String sort,String source) {
        ...
        if(source.equals("")){
            url = BaseUrl.BASE_URL+"clueController.do?method=getAllClues&token_id=" + token_id+"&orderType="+orderType+"&sort="+sort+"&loginOS=2"+"&page=1&rows=10";

        }
        else {
            url = BaseUrl.BASE_URL+"clueController.do?method=getAllClues&token_id=" + token_id+"&orderType="+orderType+"&sort="+sort+"&loginOS=2"+"&page=1&rows=10&nowIntention="+source;
    ...
    private void loadMore(String orderType,String sort,String source) {
        page=page+1;
        if(source.equals("")){
            url = BaseUrl.BASE_URL+"clueController.do?method=getAllClues&token_id=" + token_id+"&orderType="+orderType+"&sort="+sort+"&loginOS=2"+"&page="+page+"&rows=10";
        }
        else {
            url = BaseUrl.BASE_URL+"clueController.do?method=getAllClues&token_id=" + token_id+"&orderType="+orderType+"&sort="+sort+"&loginOS=2"+"&page="+page+"&rows=10&nowIntention="+source;
        }
        Log.i("loadMore",url);
        RestClient.builder()
                .url(url)

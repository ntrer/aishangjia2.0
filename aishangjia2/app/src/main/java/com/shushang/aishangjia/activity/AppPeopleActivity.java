...
//        });
    ...
    private void getActivity() {
        ...
        isUnderLine=intent.getStringExtra("isUnderLine");
        ...
        if(isCheck!=null&&isCheck.equals("0")){
            ...
            Log.d("isclickable",mButton2.isClickable()+"");
            ...
            case R.id.btn_submit:
               ...
               if(mTvCustomerGender.getText().toString().replace(" ", "").equals("男")){
                ...
                if((isUnderLine==null||isUnderLine.equals(""))&&(isCheck==null||isCheck.equals(""))){
                    if(username.equals("")||phone.equals("")||sex.equals("")||xiaoqu.equals("")||decorationProgress.equals("")||thinkBuyGood.equals("")||activity.equals("")||yzmCode.equals("")||address.equals("")){
                    ...
                    if(username.equals("")||phone.equals("")||sex.equals("")||xiaoqu.equals("")||decorationProgress.equals("")||thinkBuyGood.equals("")||activity.equals("")||yzmCode.equals("")||cardNum.equals("")||address.equals("")){
                        Toast.makeText(this, "必填项不能为空1", Toast.LENGTH_SHORT).show();
                        mButton.setEnabled(true);
                        return;
                    }
                    ...
                    if(username.equals("")||phone.equals("")||sex.equals("")||xiaoqu.equals("")||decorationProgress.equals("")||thinkBuyGood.equals("")||activity.equals("")||cardNum.equals("")||address.equals("")){
                        Toast.makeText(this, "必填项不能为空1", Toast.LENGTH_SHORT).show();
                        mButton.setEnabled(true);
                        return;
                    }
...
//                }
    ...
    public void submit(String username, String phone, String sex, String address, String xiaoqu, String decorationStyle, String decorationProgress, String sheng_name, String shi_name, String qu_name, String sheng_code, String shi_code, String qu_code, String activityName, String activityCode, String activityId, String thinkBuyGood, String yzmCode, String cardNum) {
        String url =  BaseUrl.BASE_URL + "phoneApi/customerManager.do?method=saveCustomer&loginOS=2";
        Log.d("创建活动", url);

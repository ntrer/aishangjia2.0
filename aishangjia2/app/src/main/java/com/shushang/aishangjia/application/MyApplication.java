...
//        MagicScreenAdapter.initDesignWidthInDp(380);
        SpeechUtility.createUtility(this, SpeechConstant.APPID +"=5bff5946");
        initOKHttp();
        setUpDataBase();
        //工具类初始化
...
//        UMConfigure.init(this,"5bf21b6cf1f55648ef000018","Umeng", UMConfigure.DEVICE_TYPE_PHONE, "c6dcda40ded69817693c65895be8c2ee");
        ...
        if(PreferencesUtils.getString(this,"token_id")!=null){
            JPushInterface.setAlias(this,2018,token_id);
        }
    }
